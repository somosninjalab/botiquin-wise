...
const STATS = [
  { value: 25000, label: "personas comparando", suffix: "+", color: COLORS.primary },
  { value: 50000, label: "medicinas buscadas", suffix: "+", color: COLORS.accent },
  { value: 5000, label: "quieren ser parte", suffix: "+", color: COLORS.ink },
];

const fmt = (n: number) => Math.round(n).toLocaleString("es-VE");

export const T3Thanks = () => {
