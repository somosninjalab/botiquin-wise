...
export const SceneProblemsList = () => {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 28, width: "100%", maxWidth: 920 }}>
        {PROBLEMS.map((p, i) => {
          const d = 18 + i * 14;
          ...
          return (
            ...
            >
              <div style={{ fontSize: 72, lineHeight: 1 }}>{p.icon}</div>
              <div style={{ fontSize: 44, fontWeight: 800, color: COLORS.ink, flex: 1, lineHeight: 1.15 }}>
                {p.text}
              </div>
            </div>
          );
